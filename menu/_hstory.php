                    ...
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Recently Browsed</h6><a class="dropdown-item fs--1 px-card py-1 hover-primary" href="app/events/event-detail.html">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="fw-normal title">p <span class="fas fa-chevron-right mx-1 text-500 fs--2" data-fa-transform="shrink-2"></span> Events</div>
                        </div>
                      </a>
                      ...
                      <hr class="bg-200 dark__bg-900" />
                      <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Members</h6><a class="dropdown-item px-card py-2" href="p/user/profile.html">
                        <div class="d-flex align-items-center">
                      ...
                      <a class="dropdown-item px-card py-2" href="p/user/profile.html">
                        <div class="d-flex align-items-center">
  ...
  <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
    <li class="nav-item">
      <!-- <div class="theme-control-toggle fa-icon-wait px-2">
        ...
        <div class="form-check form-switch ps-0 pt-1 pe-3"><input class="form-check-input ms-0 me-2" id="switchDarkModeExample" type="checkbox" data-theme-control="theme" /></div>
    </li>
                    ...
                    <div class="scrollbar-overlay navbar-dropdown-dots">
                      <div class="card-body px-3">
                        <div class="row text-center gx-0 gy-0">
                          <div class="col-4"><a class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="p/user/profile.html" target="_blank">
      ...
      <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
        <div class="bg-white dark__bg-1000 rounded-2 py-2">
          <!-- <a class="dropdown-item fw-bold text-warning" href="#!"><span class="fas fa-crown me-1"></span><span>Go Pro</span></a>
                    ...
                    <a class="dropdown-item" href="p/user/profile.html">Profile &amp; account</a>
                    <a class="dropdown-item" href="#!">Feedback</a> -->

          <!-- <div class="dropdown-divider"></div> -->
          <!-- <a class="dropdown-item" href="p/user/settings.html">Settings</a> -->
          <a class="dropdown-item" href="../../logout/index.php">Logout <?php echo $_SESSION['fname']; ?></a>
        </div>
      </div>
    </li>
  </ul>
