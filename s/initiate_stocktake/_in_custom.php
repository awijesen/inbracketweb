...
$chamber = htmlspecialchars($_POST['cmbr'] ?? '');
...
if ($resultz->num_rows === 0) {
    ...
    $stmtzn = $conn->prepare("INSERT INTO INB_STOCKTAKE_SNAPSHOT
                                ...
                                WHERE CustomFieldTwo='".$chamber."'");
    // $stmtz->bind_param('sssisssssss', $order, $pcode, $desc, $quantity, $user, $assignedby, $actualtime, $customer, $reference, $shipday, $uom);
    $stmtzn->execute();
