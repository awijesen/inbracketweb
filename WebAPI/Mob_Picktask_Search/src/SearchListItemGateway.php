...
class SearchListItemGateway
{
    ...
    {
        $sql = "SELECT 
        COUNT(distinct(O.ProductCode)) AS 'TotalLineCount',
        COUNT(distinct(P.ProductCode)) AS 'TotalLinesPicked'
        FROM GRW_INB_ASSIGNED_ORDERS O
        LEFT OUTER JOIN INB_ORDER_PICKS P ON P.ProductCode=O.ProductCode
