...
class InwardsSearchController
{
    public function __construct(private InwardsSearchGateway $gateway) {

    }
    public function processRequest(string $method, ?string $po, ?string $so) : void
    {
        if($so === null || $po === null) {
            if($method == "GET") {
