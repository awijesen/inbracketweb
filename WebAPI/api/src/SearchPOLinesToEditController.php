...
class SearchPOLinesToEditController
{
    public function __construct(private SearchPOLinesToEditTaskGateway $gateway) {

    }
    public function processRequest(string $method, ?string $id, ?string $so) : void
    {
        if($id === null || $so === null) {
            if($method == "GET") {
