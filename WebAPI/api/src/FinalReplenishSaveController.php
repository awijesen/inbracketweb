...
class FinalReplenishSaveController
{
    public function __construct(private FinalReplenishSaveGateway $gateway) {
    ...
    private function getValidationErrors(array $data): array
    {
        ...
        if(empty($data["AddtoPickfaceStock"])) {
            $errors[] = "Pickface Stock is required";
        }

        if(empty($data["ID"])) {
            $errors[] = "Bulk stock ID is required";
        }

        if(empty($data["BulkQuantity"])) {
            $errors[] = "BulkQuantity is required";
        }
