...
class PackListIDSearchGateway
{
    ...
    public function get(string $packid): array | false
    {

        $sql = "SELECT * FROM INB_PACK_LIST_DETAIL WHERE packListId=:packListId";

        $stmt = $this->conn->prepare($sql);
        $stmt->bindValue(":packListId", $packid, PDO::PARAM_STR);
        $stmt->execute();
