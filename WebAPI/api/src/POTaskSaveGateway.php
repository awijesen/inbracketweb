...
class POTaskSaveGateway
{
    ...
    {
        $sql = "SELECT PlateNumber FROM INB_PURCHASE_RECEIPTS where PlateNumber=:PlateNumber";
        ...
        if (empty($datax)) {
            ...
            $stmt->bindValue(":ReceivedQuantity", $data["ReceivedQuantity"], PDO::PARAM_INT);
            $stmt->bindValue(":ReasonCode", $data["ReasonCode"], PDO::PARAM_STR);
            $stmt->bindValue(":PlateNumber", $data["PlateNumber"], PDO::PARAM_STR);
            $stmt->bindValue(":ReceiptStatus", $data["ReceiptStatus"], PDO::PARAM_STR);
            ...
            if (empty($data["ReceiptStatus"])) {
                $stmt->bindValue(":ReceiptStatus", null, PDO::PARAM_NULL);
            } else {
                $stmt->bindValue(":ReceiptStatus", $data["ReceiptStatus"], PDO::PARAM_STR);
            }
