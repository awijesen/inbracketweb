...
class AllPackListGateway
{
    ...
    public function get(string $barcode): array | false
    {
        ...
        det.CustomerName, 
        case 
        when det.packListId is null && pl.packListId != '' then 'notavailable'
        else 'available'
        end as 'nilscanstatus'
        FROM INB_PACK_LIST pl
        LEFT OUTER JOIN INB_PACK_LIST_DETAIL det on det.packListId=pl.packListId
        GROUP BY pl.packListId
        ORDER BY pl.CreatedOn DESC";
