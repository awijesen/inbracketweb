...
if(isset($_SESSION['LOGGED']) && $_SESSION['LOGGED'] == 'Logged') {
  header("Location: /p/order_manager");
}
?>
                  ...
                  <div class="col-md-5 text-center bg-card-gradient">
                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                      ...
                      <div class="z-index-1 position-relative"><a class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder" href="index.html"><img src="assets/img/gallery/inBracket_logo_new.png" style="height:40px"/></a>
                        <p class="opacity-75 text-white">A comprehensive Warehouse Management System built to drive business growth by increasing operational efficiency and accuracy.</p>
                      </div>
                    </div>
                    ...
                    <div class="p-4 p-md-5 flex-grow-1">
                      ...
                      <form method="POST" id="uf" name="uf" action="">
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="em" type="email" />
                        </div>
                        <div class="mb-3">
                          <div class="d-flex justify-content-between">
                            <label class="form-label" for="ps">Password</label>
                          </div>
                          <input class="form-control" id="ps" type="password" />
                        </div>
                        <div class="row flex-between-center">
                          <div class="col-auto">
                        ...
                        <div class="mb-3">
                          <input class="btn btn-primary d-block w-100 mt-3" id="lb" type="submit" name="submit" value="Login">
                        </div>
                      </form> 
...
<script>
  $('#uf').submit(function(eh){
    ...
    $.ajax({
      type: "POST",
      data:{u:_un, p:_p},
      url: "p/authentication/_verify.php",
      success: function(returnMessage) {
        if(returnMessage == 'Invalidentries') {
          // $('#em').css("border", "1px solid orange");
             $('.errormessage').html('Login credentials required');
             setTimeout(() => {
              $('#lb').prop('value', 'Login');
             }, 1000);
          ...
          // alert(returnMessage);
            ...
            // window.location.href = returnMessage;
            location.reload();
