      ...
      <div class="content">
        ...
        <div class="card mb-3">
          ...
          <div class="card-header bg-light">
            <div class="row justify-content-between align-items-center">
              <div class="col-10">
                <div class="row">
                  <div class="col-12">
                    <h5 class="card-header-title mb-0 col-12">Negative Stock on Hand Report</h5>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body position-relative">
            ...
            <table id="negative_stock_report_tab" class="table table-striped table-hover dt-responsive display compact font-sans-serif fs--1" style="width: 100% !important">
              <thead>
                <tr>
                  <th>Product&nbsp;Code</th>
                  <th>Description</th>
...
<script>
  $(document).ready(function() {
    ...
    $('#negative_stock_report_tab').DataTable({
      'processing': true,
      'serverSide': true,
      'serverMethod': 'post',
      'pageLength': 20,
    ...
    inprogressTable = $("#negative_stock_report_tab").DataTable();
    ...
    $('#refresh_btn_id').on('click', function(re) {
      re.preventDefault();
      $('#negative_stock_report_tab').DataTable().ajax.reload();
    })
  });
</script>