...
$searchByPickface = $_POST['searchByPickface'];
...
if($searchByPickface != ''){
    $searchQuery .= " and (q.Pickface LIKE '%".$searchByPickface."%') ";
}
...
LEFT OUTER JOIN (SELECT k.Pickface, k.ProductCode FROM INB_PICKFACE_STOCK k) as q on q.ProductCode=ms.ProductCode
WHERE 1 ".$searchQuery."");
