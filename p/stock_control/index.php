        ...
        <div class="card mb-3">
          ...
          <div class="card-header bg-light">
            <div class="row justify-content-between align-items-center">
              <div class="col-10">
                <div class="row">
                  <div class="col-12">
                    <h5 class="card-header-title mb-0 col-12">Stock Control</h5>
                    <div><span class='badge badge-sm' style='background-color: var(--falcon-red)'>beta release 1.0</span></div>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body position-relative">
            ...
            <div class="row">
              ...
              <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
                <label for="searchByPickface">Pickface</label>
                <input type="text" name="searchByPickface" id="searchByPickface" class="form-control form-control-sm">
              </div>
              <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
...
<script>
  $(document).ready(function() {
    ...
    var dataTable = $('#stockControl_table').DataTable({
      ...
      'ajax': {
        ...
        'data': function(data) {
          ...
          data.searchByPickface = $('#searchByPickface').val();
        }
      },
      'columnDefs': [
    ...
    stockcontrolTable = $("#stockControl_table").DataTable();
    stockcontrolTable.buttons().container().appendTo('#exp');
  ...
  $('#filterRecs').on('change', function(ef) {
    ...
    stockcontrolTable.page.len(optVal).draw();
    // alert(optVal);
  })
