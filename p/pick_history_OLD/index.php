      ...
      <div class="content">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body position-relative">
            ...
            <table id="pick-history-tab" class="table table-striped table-hover dt-responsive display compact font-sans-serif fs--1" style="width: 100% !important">
              <thead>
                <tr>
                  <th>Sales&nbsp;Order</th>
                  <th>Print</th>
...
<script>
  $(document).ready(function() {
    ...
    inprogressTable = $("#pick-history-tab").DataTable();
    ...
    $('#refresh_btn_id').on('click', function(re) {
      re.preventDefault();
      $('#pick-history-tab').DataTable().ajax.reload();
    })
  });
</script>