...
$orderToFetchto = htmlspecialchars($_POST['links'] ?? '');

$output= array();
$sql = "SELECT 
pk.ProductCode,
ord.ProductDescription,
ord.OrderQuantity as 'OrderQty',
pk.PickedQty,
pk.InvoicedOn,
pk.ReasonCode,
pk.InvoicedBy
...
if(isset($_POST['search']['value']))
{
	...
	$sql .= " OR InvoicedBy like '%".$search_value."%'";
...
while($row = mysqli_fetch_array($query))
{
	...
	$sub_array[] = $row['InvoicedOn'];
	$sub_array[] = $row['InvoicedBy'];
	$data[] = $sub_array;
}
