            ...
            <div class="row justify-content-between align-items-center">
              <div class="col-10">
                <div class="row">
                  <div class="row">
                    <div class="col-1">
                      <a href="../invoice_history/" class="btn btn-primary btn-sm" style="background-color: var(--falcon-blue)">Back</a>
                    </div>
                    <div class="col-5">
                      <h5 class="card-header-title mb-0">Invoice History Details</h5>
                    </div>
                  </div>
                </div>
              </div>
