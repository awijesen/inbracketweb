                    ...
                    <div class="card-header bg-light">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-10">
                                <div class="row">
                                    <div class="col-3">
                                        <h5 class="card-header-title mb-0 col-12">Stock Trail Enquiry</h5>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body position-relative">
                        ...
                        <form class="row gy-2 gx-3 align-items-center" id="search-product">
                            <div class="col-auto">
                                ...
                                <input class="form-control" name="autoSizingInputProduct" id="autoSizingInputProduct" type="text" placeholder="Product code" /></div>

                            <div class="col-auto"><button class="btn btn-primary" type="submit" id="search-product-btn">Search</button></div>
                        </form>
