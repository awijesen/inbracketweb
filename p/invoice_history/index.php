      ...
      <div class="content">
        ...
        <div class="card mb-3">
          ...
          <div class="card-header bg-light">
            <div class="row justify-content-between align-items-center">
              ...
              <div class="row justify-content-end p-0">
                <div class="col-4">
                  <h5 class="card-header-title mb-0 col-12">Invoice History Report</h5>
                </div>

                <!-- <div class="row"> -->
                <div class="row col-md-8 d-flex justify-content-end">
                  ...
                  <!-- <div class="col-md-4 col-lg-3">
                    <div class="form-group">
                      <input class="form-control form-control-sm datetimepicker" id="timepicker2" type="text" placeholder="dd/mm/yy to dd/mm/yy" data-options='{"mode":"range","dateFormat":"d/m/y"}'>
                    </div>
                  </div> -->
                  <div class="col-md-4 col-lg-3">
          ...
          <div class="card-body position-relative">
            ...
            <table id="invoice_hostory_tab" class="table table-striped table-hover dt-responsive display compact font-sans-serif fs--1" style="width: 100% !important">
              <thead>
                <tr>
                  <th>SO&nbsp;Number</th>
                  <th>Customer</th>
