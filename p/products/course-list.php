                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-xxl-3">
                                                <div class="nav flex-column">
                                                    ...
                                                    <p class="nav-link text-700 mb-0 fw-bold">ECharts</p><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/d3js.html">D3js<span class="badge rounded-pill ms-2 badge-subtle-success">New</span></a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/line-charts.html">Line charts</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/bar-charts.html">Bar charts</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/candlestick-charts.html">Candlestick charts</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/geo-map.html">Geo map</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/scatter-charts.html">Scatter charts</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/pie-charts.html">Pie charts</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/gauge-charts.html">Gauge charts</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/charts/echarts/radar-charts.html">Radar charts</a>
                                                </div>
                                            </div>
                                            <div class="col-6 col-xxl-3">
                                                <div class="nav flex-column">
                                                    <p class="nav-link text-700 mb-0 fw-bold">Utilities</p><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/components/tooltips.html">Tooltips</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/components/treeview.html">Treeview</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/components/typed-text.html">Typed text</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/components/videos/embed.html">Embed</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/components/videos/plyr.html">Plyr</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/borders.html">Borders</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/clearfix.html">Clearfix</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/colors.html">Colors</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/colored-links.html">Colored links</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/display.html">Display</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/flex.html">Flex</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/float.html">Float</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/grid.html">Grid</a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/overlayscrollbar.html">Overlay scrollbar<span class="badge rounded-pill ms-2 badge-subtle-success">New</span></a><a class="nav-link py-1 link-600 fw-medium" href="../../../modules/utilities/position.html">Position</a>
                                                </div>
                                            </div>
                                            <div class="col-6 col-xxl-3">
                                ...
                                <li class="border-bottom"><a class="nav-link collapse-indicator-plus fs--2 fw-medium text-600 py-3" data-bs-toggle="collapse" href="#category-collapse" aria-controls="category-collapse" aria-expanded="true">Category</a>
                                    <div class="collapse show" id="category-collapse">
                                        <ul class="list-unstyled">
                                            <li>
                                                <div class="">
                                                    </select><select class="form-select form-select-sm mb-2 mt-2" name="searchByActiveStatus" id="searchByActiveStatus" aria-label=".form-select-sm example">
                                                        <option selected value="">All</option>
                                                        <option value="1">Active</option>
                                                        <option value="0">Inactive</option>
                                                    </select>
                                                    <!-- <input type="text" name="searchByActiveStatus" id="searchByActiveStatus"> -->
        ...
        var dataTable = $('#vehiclesTable').DataTable({
            ...
            'ajax': {
                ...
                'data': function(data) {
                    ...
                    // data.searchBySubModel = $('#searchBySubModel').val();
                    // data.searchByYear = $('#searchByYear').val();
                    // data.searchByLeaves = $('#searchByLeaves').val();
                    // data.searchByPartNo = $('#searchByPartNo').val();
                    // data.searchByPartNoInput = $('#searchByPartNoInput').val();
                    // data.searchByOENumber = $('#searchByOENumber').val();
                    // data.requestFromFilter = requestFromFilter;
                }
            },
            'columns': [{
                    data: 'ProductCode'
            ...
            //     if ($('#searchByActiveStatus').val() == '' && $('#searchByOENumber').val() == '') {
            //         $('#searchByName').html(settings.json.makeFilters);
            //         $('#searchByModel').html(settings.json.modelFilters);
            //         $('#searchBySubModel').html(settings.json.subModelFilters);
            //         $('#searchByYear').html(settings.json.yearFilters);
            //         $('#searchByLeaves').html(settings.json.leaveFilters);
            //         $('#searchByPartNo').html(settings.json.partNoFilters);
            //     }
            //     requestFromFilter = 0;
            // }
        });
