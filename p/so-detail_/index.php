            ...
            <div class="row justify-content-between align-items-center">
              <div class="col-10">
                <div class="row">
                  <div class="row">
                    <div class="col-1">
                      <a href="../schedule_history/" class="btn btn-primary btn-sm" style="background-color: var(--falcon-blue)">Back</a>
                    </div>
                    <div class="col-5">
          ...
          <div class="card-body position-relative card-body-inner">
            ...
            <div>
              ...
              <div class="row">
                ...
                <!-- table here -->
                <table id="salesorder_details" class="table table-striped table-hover dt-responsive display compact font-sans-serif fs--1 custFontSize" style="width: 100% !important">
