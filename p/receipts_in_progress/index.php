      ...
      <div class="content">
        ...
        <div class="card mb-3">
          ...
          <div class="card-header bg-light">
            <div class="row justify-content-between align-items-center">
              <div class="col-10">
                <div class="row">
                  <div class="col-3">
                    <h5 class="card-header-title mb-0 col-12">Inward Tasks - In Progress</h5>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body position-relative">
            ...
            <div class="row">
              <div class="row col-md-12 d-flex justify-content-end">
                <div class="d-flex justify-content-end col-md-5">
                  <div class="col-5" id="exporter"></div>
            ...
            <table id="picked-in-progress" class="table table-stripe table-hover dt-responsive display compact font-sans-serif fs--1 custFontSize" style="width: 100% !important">
              <thead>
                <tr>
                  <th>PO&nbsp;Number</th>
                  <th>Vendor&nbsp;Name</th>
...
<script>
  $(document).ready(function() {
    ...
    $('#picked-in-progress').DataTable({
      ...
      'columnDefs': [
      { "targets": [2,5, 6], // your case first column
