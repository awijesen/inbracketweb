            ...
            <div class="row justify-content-between align-items-center">
              <div class="col-10">
                <div class="row">
                  <div class="row">
                    <div class="col-1">
                      <a href="../receipts_in_progress/" class="btn btn-primary btn-sm" style="background-color: var(--falcon-blue)">Back</a>
                    </div>
                    <div class="col-5">
                      <h5 class="card-header-title mb-0">Inward Task Details</h5>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body position-relative card-body-inner">
            ...
            <div>
              ...
              <div class="col-lg-12" style="padding: 1.25rem">
                ...
                <div class="col-3" id="exporter"></div>
                <div class="col-3">
    <select class="form-select form-select-sm col-2" name="filterRecs_InProgress" id="filterRecs_InProgress" style="padding-right:2px; background-position: top 8px right 4px">
      ...
      <option value="1000000000">All</option>
                ...
                <table id="orderpick_details" class="table table-stripe table-hover dt-responsive display compact" style="width: 100% !important">
