          ...
          <div class="card-body position-relative">
            ...
            <div>
              ...
              GROUP BY pk.SalesOrderNumber";
                ...
                ?> <table id="dataRef" class="table table-hover table-striped table-sm overflow-hidden font-sans-serif fs--1">
                  <thead>
                    <tr>
                      <th>Order&nbsp;Number</th>
                      <th>Picker</th>
                  ...
                  <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                      if ($row["OOSstatus"] === 'Review') {
                        $entry = "<span class='badge' style='background-color: var(--falcon-red); min-width: 62px !important'>Review OOS</span>";
                      } else {
                        $entry = "<span class='badge' style='background-color: var(--falcon-green); min-width: 62px !important'>Fully Picked</span>";
                      }
