              ...
              <div class="col-9">
                <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <h5 class="card-header-title mb-0 col-12">Assign Purchase Orders</h5>
                  </div>
                </div>
              </div>
              <div class="col-3 ps-0 ps-sm-3">
                <div class="row">
                  <div class="col-6">
                    <p class="fs--1 text-info" href="#">Total&nbsp;Order&nbsp;Value&nbsp;: </p>
                  </div>
                  <div class="col-6">
                    <p class="fs--1 text-info" id="totalOrderVal"></p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                    <button id="_assign_ord_po" type="button" class="btn btn-falcon-primary btn-sm">Assign</button>
                  </div>
                  <div class="row col-md-9 d-flex justify-content-end">
                    ...
                    <div class="d-flex justify-content-end col-md-5">
                      <button class="ml-2 btn btn-falcon-default btn-sm me-3" id="refresh_btn_id2">Fetch&nbsp;New</button>
                      <button class="ms-2 me-2 btn btn-falcon-default btn-sm me-3" id="refresh_btn_id2">Refresh</button>
                      <div id="mohanw"></div>
                      <select class="form-select form-select-sm" name="filterPORecs" id="filterPORecs" style="padding-right:2px; background-position: top 8px right 4px">
                ...
                <table id="assign_order_table" class="table table-striped table-hover dt-responsive display compact font-sans-serif fs--1" style="width: 100% !important">
                  <thead>
                    <tr>
                      <th>...</th>
                      <th>Receiver</th>
