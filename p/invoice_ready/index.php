      ...
      <div class="content">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body position-relative">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 d-flex justify-content-end px-1">
                  <div>
                    <label for="exporter">&nbsp;</label>
                    <div class="col-md-1 col-lg-1" id="exporter"></div>
                  </div>
                  <div>
                    <label for="refresh_btn_id22">&nbsp;</label>
                    <div>
                    <button class="ml-2 btn btn-falcon-default btn-sm me-2" name="refresh_btn_id22" id="refresh_btn_id22">Refresh</button>
                    </div>
                  </div> 
              </div>
              <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12 ps-1">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body pt-0 pt-md-3">
            <table id='OrderToBeInvoicedTable' class="table table-striped table-hover dt-responsive display compact font-sans-serif fs--1" style="width: 100% !important">
              <thead>
                <tr>
                  <th>Sales&nbsp;Order</th>
                  <th>Print</th>
...
<script>
  $(document).ready(function() {
    ...
    var dataTable = $('#OrderToBeInvoicedTable').DataTable({
      'processing': true,
      'serverSide': true,
      'serverMethod': 'post',
      'stateSave': true,
    ...
    inprogressTable = $("#OrderToBeInvoicedTable").DataTable();
  ...
  $('#refresh_btn_id22').on('click', function(gh){
    gh.preventDefault();
    $('#OrderToBeInvoicedTable').DataTable().ajax.reload();
  })
</script>