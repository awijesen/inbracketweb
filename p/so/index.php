...
<head>
  ...
  <script type="text/javascript" charset="utf8" src="js/index.js">
  </script>
...
<body>
  <!-- <form method="post">
    <p><input type="submit" name="btnSync" class="btn btn-success" value="Sync" />&nbsp;<input type="button" id="btnRefresh" class="btn btn-primary" value="Refresh" /></p>
  </form> -->
  <?php
  ...
  <!-- <div class="container">
        ...
        <form method="post">
            <div style="margin-bottom:3em;">
                <p>
                    <select class="form-control-sm" name="cboPicker">
                        <option>&nbsp;</option>
                        <option value="Picker 1">Picker 1</option>
                        <option value="Picker 2">Picker 2</option>
                    </select>
                    <input type="submit" name="btnAssign" class="btn btn-secondary" value="Assign" />
                </p>
            </div>
           
            <table id="tblSo" class="display table">
                <thead>
                    <tr>
                        <th>Sales Order</th>
                        <th>Picker</th>
        ...
        <div class="card mb-3">
            ...
            <div class="row justify-content-between align-items-center">
              <div class="col-10">
                <div class="row">
                  ...
                  <div class="col-3">                   
                      <button type="button" class="btn btn-link" name="syncOrders" id="syncOrders"><i class="fa-solid"></i></button>
          ...
          <div class="card-body position-relative">
            <div class="row">
              <div class="col-lg-12">
                <!-- table here -->
                <table id="tblSo" class="table table-stripe table-hover dt-responsive display compact" style="width: 100% !important">
