      ...
      <div class="content">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12">
          <div class="card mb-3">
            ...
            <div class="col-4">
              <input type="button" class="btn btn-primary" id="add_loc" value="Create Pickface" style="margin-top: 32px !important">
            </div>
          </div>
          <div class="row">
            <div class="col-12 mt-2" id="alert-msg" style="color: var(--falcon-red); font-size: 14px !important"></div>
          </div>
          <!-- close body -->
        </div>
      </div>
    ...
    $('#locas').select2({
      ajax: {
          ...
          success: function(msgx) {
            for(i=0; i < msgx.length; i++) {
              $('#locas').append('<option>' + msgx[i].ProductCode + '</option>');
            }
          }
        }
      })
