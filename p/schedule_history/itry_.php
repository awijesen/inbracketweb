...
foreach ($_POST['id'] as $key => $id) {
    ...
    if ($result->num_rows !== 0) {
        //add
        $stmt = $conn->prepare("INSERT INTO GRW_INB_ASSIGNED_ORDERS (SalesOrderNumber, ProductCode, ProductDescription, OrderQuantity, Picker, AssignedBy, OrderCustomer, Reference, AssignedOn, ShipDay, UOM, Notes, OnHoldReason, OrderCustomerId)
