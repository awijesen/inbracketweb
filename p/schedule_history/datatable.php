<?php
   ...
   foreach ($empRecords as $row) {
      ...
      if($row["OnHoldReason"] == null) {
         ...
         $onholdreason = "<span id='reason-view' orderref='".$row["SalesOrderNumber"]."' rmessage='".$row["OnHoldReason"]."' class='fas fa-sticky-note fs-5' style='color: var(--falcon-gray); font-size: 14px !important; margin-top:2px'></span>";
      }
      ...
      $data[] = array(
         ...
         "SalesOrderNumber"=>'<a rel="noopener noreferrer" href="../so-detail_/index.php?link='.$row['SalesOrderNumber'].'" class="orderRef_" id='.$row['SalesOrderNumber'].'>'.$row['SalesOrderNumber'].'</a>',
         "orderType"=>$clothing,
