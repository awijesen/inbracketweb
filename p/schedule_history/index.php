              ...
              <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="row">
                  <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <h5 class="card-header-title mb-0 col-12">Scheduled Order History</h5>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body position-relative">
            <form action="" method="POST" name="_as_fm" id="_as_fm">
              <div class="container-fluid">
                ...
                <div class="row">
                  <table id="jquery-datatable-ajax-php" class="table table-striped table-hover dt-responsive display compact font-sans-serif custFontSize" style="width: 100% !important">
                    <thead>
                      <tr>
                        <th>...</th>
                        <th>Sales&nbsp;Order</th>
