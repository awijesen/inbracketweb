...
$output= array();
$sql = "SELECT SalesOrderNumber as 'SalesOrderNumber',
ProductCode as 'ProductCode',
ProductDescription as 'ProductDescription',
sum(OrderQuantity) as 'OrdQty'
from GRW_INB_SALES_ORDERS
WHERE SalesOrderNumber='".$orderToFetchto."'
